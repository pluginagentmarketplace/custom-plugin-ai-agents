...
This guide provides comprehensive documentation for the **rag-systems** skill in the custom-plugin-ai-agents plugin.
...
```bash
# Invoke the skill
claude "rag-systems - [your task description]"

# Example
claude "rag-systems - analyze the current implementation"
```
...
def implement_rag_systems(input_data):
    """
    Implement rag-systems functionality.
