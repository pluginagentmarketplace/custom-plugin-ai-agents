...
This guide provides comprehensive documentation for the **multi-agent** skill in the custom-plugin-ai-agents plugin.
...
```bash
# Invoke the skill
claude "multi-agent - [your task description]"

# Example
claude "multi-agent - analyze the current implementation"
```
...
def implement_multi_agent(input_data):
    """
    Implement multi-agent functionality.
