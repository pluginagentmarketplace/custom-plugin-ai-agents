...
This guide provides comprehensive documentation for the **tool-calling** skill in the custom-plugin-ai-agents plugin.
...
```bash
# Invoke the skill
claude "tool-calling - [your task description]"

# Example
claude "tool-calling - analyze the current implementation"
```
...
def implement_tool_calling(input_data):
    """
