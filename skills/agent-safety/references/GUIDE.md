...
This guide provides comprehensive documentation for the **agent-safety** skill in the custom-plugin-ai-agents plugin.
...
```bash
# Invoke the skill
claude "agent-safety - [your task description]"

# Example
claude "agent-safety - analyze the current implementation"
```
...
def implement_agent_safety(input_data):
    """
    Implement agent-safety functionality.
