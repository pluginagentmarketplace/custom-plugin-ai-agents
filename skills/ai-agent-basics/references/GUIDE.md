...
This guide provides comprehensive documentation for the **ai-agent-basics** skill in the custom-plugin-ai-agents plugin.
...
```bash
# Invoke the skill
claude "ai-agent-basics - [your task description]"

# Example
claude "ai-agent-basics - analyze the current implementation"
```
...
def implement_ai_agent_basics(input_data):
    """
    Implement ai-agent-basics functionality.
