...
This guide provides comprehensive documentation for the **llm-integration** skill in the custom-plugin-ai-agents plugin.
...
```bash
# Invoke the skill
claude "llm-integration - [your task description]"

# Example
claude "llm-integration - analyze the current implementation"
```
...
def implement_llm_integration(input_data):
    """
    Implement llm-integration functionality.
